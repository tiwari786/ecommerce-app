...
export default function CartPage() {
  ...
  return (
    <main className="bg-gray-50 min-h-screen py-6 sm:py-10">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 sm:mb-6">My Cart</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
          ...
          <section data-testid='cart-item' aria-label="cart-items" className="lg:col-span-2 space-y-3 sm:space-y-4">
            ...
            {cart.map((item) => (
              <div
                key={item.id}
                className="bg-white rounded-xl shadow-sm p-4 sm:p-5 flex gap-4 items-center"
              >
                <img
                  src={item.image}
          ...
          <aside aria-label="Order Summary" className="bg-white p-4 sm:p-6 rounded-xl shadow-sm h-fit sticky top-4">
